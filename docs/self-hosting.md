...
```bash
# videolify P2P - HTTPS — proxy all requests to the Node app
server {
	# Enable HTTP/2
...
Check Your videolify P2P instance: https://your.domain.name

---

## Update script

In order to have always Your videolify P2P updated to latest, we going to create a script
