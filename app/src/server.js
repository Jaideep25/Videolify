...
app.get("/join/", (req, res) => {
  if (Object.keys(req.query).length > 0) {
    ...
    /* 
            http://localhost:3000/join?room=test&name=videolify&audio=1&video=1&notify=1
            https://videolify.up.railway.app/join?room=test&name=videolify&audio=1&video=1&notify=1
            https://videolify.herokuapp.com/join?room=test&name=videolify&audio=1&video=1&notify=1
        */
