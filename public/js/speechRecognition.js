...
if ("webkitSpeechRecognition" in window) {
  ...
  console.warn(
    "This browser does not support webkitSpeechRecognition, check out supported browsers: https://developer.mozilla.org/en-US/docs/Web/API/Web_Speech_API#browser_compatibility"
  );
...
function updateCountry() {
  ...
  recognitionDialect.style.visibility =
